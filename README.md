# Mr Juice Ofc For Hosting Bots & Games & Other Possible servers 
...
Juiceofc® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security 
in mind, Juiceofc runs all game servers in isolated Docker containers while exposing a beautiful and intuitive
UI to end users.
...
I would like to extend my sincere thanks to the following sponsors for helping fund Juiceofc's development.
